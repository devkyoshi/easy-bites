...
import {SearchProvider, useSearch} from '@/context/search-context.tsx'
...
export function Search({ className = '', placeholder = 'Search' }: Props) {
  ...
  return (
    <SearchProvider>
        <SearchContent className={className} placeholder={placeholder} />
    </SearchProvider>
  )
}

export const SearchContent = ({ className = '', placeholder = 'Search' }: Props) => {
